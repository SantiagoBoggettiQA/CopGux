...
describe('Test Suite', () => {
  ...
  it('Assert opciones barra lateral', () => {
...
cy.origin('https://dnb6cku4pr0m8.cloudfront.net/', () => {
  ...
  cy.get('.text-end > .btn > .bi').click();
 cy.wait(2000)
cy.get('.component-side-menu__container > :nth-child(3) > :nth-child(1) > .btn').should('be.visible');
...
cy.get(':nth-child(4) > .col-12 > .btn').should('be.visible');
